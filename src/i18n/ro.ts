export const ro = {
  ...
  about: {
    title: "Ce este GlobFest?",
    subtitle: "Artă, prietenie și generozitate sub același acoperiș.",
    description: "🎄 Crăciunul Prietenilor.\n🖌️ Festivalul globuletelor pictate manual.\n🫶 Eveniment caritabil.\nLa GlobFest ne adunăm cu prietenii și pictăm globulețe la o cană de ceai sau vin fiert, pe care ulterior le donăm pentru a fi vândute în scopuri caritabile.",
    announcement: "Mă bucur să pot spune că și anul acesta, GlobFest, un eveniment conceput inițial pentru petrecerea timpului cu prietenii într-un mod creativ, în așteptarea Crăciunului, continuă să aibă un caracter caritabil, prin susținerea unor cauze de suflet.\n\nDacă încă nu știți povestea GlobFest-ului, sau Crăciunul Prietenilor, cum îmi mai place să spun, nu vă neliniștiți! Aici veți găsi multe informații și numeroase poze de la evenimente, cu globulețele pictate din anii anteriori și cu toți oamenii faini și talentați care s-au perindat la acest eveniment.\n\nFie ca Nașterea Domnului să ne aducă tuturor iubire, oameni dragi în jur, pace, belșug cât și multe oportunități de a face bine!\n\nA voastră gazdă ghidușă,\nAndreea Ar\n\nCa și anul trecut, rămân cu dorința ca GlobFest să rămână un eveniment anual care să încălzească inimi și să creeze prietenii durabile.",
    cta: "Află Mai Mult",
