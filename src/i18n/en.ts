export const en = {
  ...
  about: {
    title: "What is GlobFest?",
    subtitle: "Art, friendship, and generosity under one roof.",
    description: "🎄 Friends' Christmas.\n🖌️ Hand-painted baubles festival.\n🫶 Charity event.\nAt GlobFest we gather with friends to paint Christmas baubles over a cup of tea or mulled wine, which we then donate to be sold for charitable purposes.",
    announcement: "I am happy to say that this year too, GlobFest—an event originally conceived for spending time with friends in a creative way while waiting for Christmas—continues to have a charitable character by supporting special causes.\n\nIf you don't know the story of GlobFest yet, or Friends' Christmas, as I like to call it, don't worry! Here you'll find plenty of information and many photos from events, with hand-painted baubles from previous years and all the lovely and talented people who have joined this event.\n\nMay the Birth of the Lord bring us all love, dear people around us, peace, plenty, and many opportunities to do good!\n\nYour playful host,\nAndreea Ar\n\nLike last year, I remain with the wish that GlobFest remains an annual event that warms hearts and creates lasting friendships.",
    cta: "Learn More",
